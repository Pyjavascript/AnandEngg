      ...
      Vestas: [
        ...
        },
        {
          ...
          dimensions: [
            ...
            { slNo: 12, desc: "11 mm hole distance 1", spec: "164", actual: "" },
            { slNo: 13, desc: "11 mm hole distance 2", spec: "404", actual: "" },
            { slNo: 14, desc: "11 mm hole distance 3", spec: "644", actual: "" },
            { slNo: 15, desc: "40mm Hole distance 1", spec: "1097", actual: "" },
            { slNo: 16, desc: "40mm Hole distance 2", spec: "1208", actual: "" },
            { slNo: 17, desc: "7mm hole distance", spec: "1516.5", actual: "" },
            { slNo: 18, desc: "11 mm hole distance 4", spec: "1574", actual: "" },
            { slNo: 19, desc: "11 mm hole distance 5", spec: "1814", actual: "" },
            { slNo: 20, desc: "11 mm hole distance 6", spec: "2045", actual: "" },
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerText}>
            ...
            <Text style={styles.subtitle}>Configure your inspection report</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.formCard}>
        ...
        <View style={styles.stepContainer}>
          ...
          <View style={styles.pickerWrapper}>
            <Ionicons name="document-text-outline" size={20} color="#286DA6" style={styles.pickerIcon} />
            <Picker
        ...
        {reportType ? (
          <View style={styles.stepContainer}>
            ...
            <View style={styles.pickerWrapper}>
              <Ionicons name="business-outline" size={20} color="#286DA6" style={styles.pickerIcon} />
              <Picker
        ...
        {customer ? (
          <View style={styles.stepContainer}>
            ...
            <View style={styles.pickerWrapper}>
              <Ionicons name="cube-outline" size={20} color="#286DA6" style={styles.pickerIcon} />
              <Picker
                selectedValue={part?.partNo || ""}
                onValueChange={(value) => {
                  const selected = reportsData[reportType].customers[customer].find(
                    (p) => p.partNo === value
                  );
                  setPart(selected);
                }}
          ...
          <View style={styles.previewCard}>
            ...
            <View style={styles.previewInfo}>
              ...
              <View style={styles.previewRow}>
                ...
                <Text style={styles.previewValue}>{part.dimensions.length} items</Text>
              </View>
            </View>
          </View>
        ) : null}
